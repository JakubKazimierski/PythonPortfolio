'''
Unittests for CountingMinutesIbetter.py
November 2020 Jakub Kazimierski
'''

import unittest
import CountingMinutesIbetter
...
class test_CountingMinutesIbetter(unittest.TestCase):
    ...
    def test_StartHourIsLessThanEndHour(self):
        ...
        '''
        output = CountingMinutesIbetter.CountingMinutesI("10:00am-1:00pm")
    ...
    def test_StartHourIsGreater(self):
        ...
        '''
        output = CountingMinutesIbetter.CountingMinutesI("10:00pm-1:00am")
        self.assertEqual(output, 180)
    ...
    def test_StartHourIsGreaterSameFormat(self):
        ...
        '''
        output = CountingMinutesIbetter.CountingMinutesI("10:00pm-9:00pm")
    ...
    def test_Midnight(self):
        ...
        '''
        output = CountingMinutesIbetter.CountingMinutesI("12:01pm-12:00pm")
